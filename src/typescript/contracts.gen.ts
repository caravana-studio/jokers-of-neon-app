...
// Generated by dojo-bindgen on Sat, 24 Aug 2024 17:45:52 +0000. Do not modify this file manually.
...
export async function setupWorld(provider: DojoProvider) {
    ...
    function game_system() {
        ...
        const play = async (props: { account: Account, game_id: number, cards_index: RecsType.NumberArray, modifiers_1_index: RecsType.NumberArray, modifiers_2_index: RecsType.NumberArray }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
        ...
        const discard = async (props: { account: Account, game_id: number, cards_index: RecsType.NumberArray, modifiers_1_index: RecsType.NumberArray, modifiers_2_index: RecsType.NumberArray }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
        ...
        const check_hand = async (props: { account: Account, game_id: number, cards_index: RecsType.NumberArray, modifiers_1_index: RecsType.NumberArray, modifiers_2_index: RecsType.NumberArray }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
    ...
    function shop_system() {
        ...
        const buy_card_item = async (props: { account: Account, game_id: number, item_id: number, card_item_type: models.CardItemType }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
                        ...
                        calldata: [props.game_id,
                props.item_id,
                ["None", "Common", "Modifier", "Special"].indexOf(props.card_item_type.type)],
                    },
                    "jokers_of_neon"
                );
            } catch (error) {
        ...
        // Call the `buy_blister_pack` system with the specified Account and calldata
        const buy_blister_pack = async (props: { account: Account, game_id: number, blister_pack_item_id: number }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
                        contractName: contract_name,
                        entrypoint: "buy_blister_pack",
                        calldata: [props.game_id,
        ...
        const select_cards_from_blister = async (props: { account: Account, game_id: number, cards_index: RecsType.NumberArray }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
        ...
        return {
            skip_shop, buy_card_item, buy_poker_hand_item, buy_blister_pack, select_cards_from_blister, reroll, world
        };
    }
