...
export function createClientComponents({
  ...
  return {
    ...
    CurrentSpecialCards: overridableComponent(
      contractComponents.CurrentSpecialCards
    ),
    ...
    PlayerCommonCards: overridableComponent(
      contractComponents.PlayerCommonCards
    ),
    Effect: overridableComponent(contractComponents.Effect),
    EffectCard: overridableComponent(contractComponents.EffectCard),
    PlayerEffectCards: overridableComponent(
      contractComponents.PlayerEffectCards
    ),
