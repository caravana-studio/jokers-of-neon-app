...
export function defineContractComponents(world: World) {
  return {
    ...
    Shop: (() => {
      return defineComponent(
        world,
        { game_id: RecsType.Number, reroll_cost: RecsType.Number, reroll_executed: RecsType.Boolean, len_item_common_cards: RecsType.Number, len_item_modifier_cards: RecsType.Number, len_item_special_cards: RecsType.Number, len_item_poker_hands: RecsType.Number, dale: RecsType.StringArray },
        {
          metadata: {
