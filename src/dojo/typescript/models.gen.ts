...
// Generated by dojo-bindgen on Tue, 12 Nov 2024 22:52:07 +0000. Do not modify this file manually.
...
export const CurrentHandDefinition = {
    game_id: RecsType.Number,
    cards: RecsType.NumberArray,
...
export const DestroyedSpecialCardEventDefinition = {
    player: RecsType.BigInt,
...
export function defineContractComponents(world: World) {
    return {
        ...
        // Model definition for `jokers_of_neon::models::data::events::DestroyedSpecialCardEvent` model
        DestroyedSpecialCardEvent: (() => {
            return defineComponent(
                ...
                },
                {
                    metadata: {
                        namespace: "jokers_of_neon",
                        name: "DestroyedSpecialCardEvent",
                        types: ["ContractAddress", "u32"],
                        customTypes: [],
                    },
                }
            ...
            return defineComponent(
                ...
                },
                {
                    metadata: {
                        namespace: "jokers_of_neon",
                        name: "Game",
                        types: ["u32", "ContractAddress", "felt252", "u8", "u8", "u8", "u8", "u32", "u32", "u32", "u32", "u32", "u8", "GameState", "u32"],
                        customTypes: [],
                    },
                }
            );
