...
export async function setupWorld(provider: DojoProvider) {
	...
	const poker_hand_system_getPlayerPokerHands = async (snAccount: Account, gameId: number) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const game_system_play = async (snAccount: Account, gameId: number, cardsIndex: Array<number>, modifiersIndex: Array<number>) => {
		try {
			return await provider.execute(
				snAccount,
				{
