...
export function setupWorld(provider: DojoProvider) {
  const build_shop_system_buyBlisterPackItem_calldata = (
    gameId: BigNumberish,
    blisterPackItemId: BigNumberish
  ) => {
    return {
  ...
  const shop_system_buyBlisterPackItem = async (
    ...
    try {
      return await provider.execute(
        snAccount,
        build_shop_system_buyBlisterPackItem_calldata(
          gameId,
          blisterPackItemId
        ),
        "jokers_of_neon"
  ...
  const build_shop_system_buyBurnItem_calldata = (
    gameId: BigNumberish,
    cardId: BigNumberish
  ) => {
    return {
  ...
  const build_shop_system_buyCardItem_calldata = (
    gameId: BigNumberish,
    itemId: BigNumberish,
    ...
    return {
      ...
      calldata: [
        gameId,
        itemId,
        new CairoCustomEnum({ [itemIdToString[cardItemType]]: "()" }),
      ],
    };
  };
  ...
  const build_shop_system_buyPokerHandItem_calldata = (
    gameId: BigNumberish,
    itemId: BigNumberish
  ) => {
    return {
  ...
  const build_shop_system_buyPowerUpItem_calldata = (
    gameId: BigNumberish,
    itemId: BigNumberish
  ) => {
    return {
  ...
  const shop_system_buyPowerUpItem = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    itemId: BigNumberish
  ) => {
  ...
  const build_shop_system_buySlotSpecialCardItem_calldata = (
    gameId: BigNumberish
  ) => {
    return {
      contractName: "shop_system",
  ...
  const build_shop_system_buySpecialCardItem_calldata = (
    gameId: BigNumberish,
    itemId: BigNumberish,
    isTemporary: boolean
  ) => {
  ...
  const shop_system_buySpecialCardItem = async (
    ...
    try {
      return await provider.execute(
        snAccount,
        build_shop_system_buySpecialCardItem_calldata(
          gameId,
          itemId,
          isTemporary
        ),
  ...
  const rage_system_calculate = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish
  ) => {
    try {
  ...
  const build_game_system_discardSpecialCard_calldata = (
    gameId: BigNumberish,
  ...
  const shop_system_getShopItems = async (gameId: BigNumberish) => {
    try {
      return await provider.call(
        "jokers_of_neon",
        build_shop_system_getShopItems_calldata(gameId)
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_shop_system_selectCardsFromBlister_calldata = (
    gameId: BigNumberish,
  ...
  return {
    shop_system: {
      ...
      buildBuyBlisterPackItemCalldata:
        build_shop_system_buyBlisterPackItem_calldata,
      ...
      buildBuyPokerHandItemCalldata:
        build_shop_system_buyPokerHandItem_calldata,
      ...
      buildBuySlotSpecialCardItemCalldata:
        build_shop_system_buySlotSpecialCardItem_calldata,
      buySpecialCardItem: shop_system_buySpecialCardItem,
      buildBuySpecialCardItemCalldata:
        build_shop_system_buySpecialCardItem_calldata,
      ...
      buildSelectCardsFromBlisterCalldata:
        build_shop_system_selectCardsFromBlister_calldata,
    ...
    game_system: {
      ...
      buildDiscardEffectCardCalldata:
        build_game_system_discardEffectCard_calldata,
